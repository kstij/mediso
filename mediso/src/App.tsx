  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen bg-slate-50 font-sans selection:bg-mediso-blue selection:text-white pb-20">
      ...
      <main className="w-full flex flex-col items-center justify-center pt-24 pb-20 z-10 relative px-4 text-center">
        ...
        <h2 className="flex flex-col items-center justify-center gap-y-4 text-[42px] md:text-[56px] font-extrabold italic tracking-tight text-slate-800 mb-10 max-w-5xl leading-[1.1]">
          <div className="flex flex-row items-center gap-x-3 flex-wrap justify-center">
